...
func _run() -> void:
	...
	_check(
		...
		"production game mounts machine, husbandry and ranch lifecycle services"
	)
	if hub == null or coordinator == null or husbandry_participant == null or participant == null or machine_runtime == null:
