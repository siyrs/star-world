...
Write-Host 'PASS: full Star World regression suite including bounded hostile encounter director, hostile ranged encounters, and lifecycle-safe firearm acceptance'
