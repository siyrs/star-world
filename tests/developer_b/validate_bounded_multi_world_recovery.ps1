...
Assert-Match $text.audit '同步修复所有损坏世界' 'Architecture audit must identify unbounded synchronous repair'
Assert-Match $text.audit '主菜单卡顿' 'Architecture audit must identify the menu-stall risk'
