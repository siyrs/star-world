...
const BUTTON_W := 48
const BUTTON_H := 16
const FACE_NORMAL := Color("#828282")
const FACE_HOVER := Color("#8E9CC4")
const FACE_PRESSED := Color("#666666")
const FACE_DISABLED := Color("#5A5A5A")
const FACE_PRIMARY := Color("#5B8A32")
const FACE_PRIMARY_HOVER := Color("#6EA23E")
const FACE_PRIMARY_PRESSED := Color("#486B27")
const FACE_DANGER := Color("#8A3A2C")
const FACE_DANGER_HOVER := Color("#A04635")
const FACE_DANGER_PRESSED := Color("#6E2D22")
